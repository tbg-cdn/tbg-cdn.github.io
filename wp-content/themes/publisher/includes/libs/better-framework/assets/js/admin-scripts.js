...
var bf_ignore_reload_notice = false,
    ...
    return {
        ...
        _interactive_field_change: function (e, el, inputWrapperSelector, parentSelector, paramDataName, paramSettingsName) {
        ...
        setup_interactive_fields_for_bf: function () {
            var self = this;

            var $wrapper = $("#bf-main");

            $wrapper.on('change force-change', ':input', function (e) {
                self._interactive_field_change(e, this, '.bf-section-container,.fields-group', '.group', 'param-name', 'param-settings')
            });
        ...
        setup_fields: function($context) {
            ...
            this.setup_interactive_fields_for_bf();
        },
